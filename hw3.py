...
if __name__ == "__main__":
    train_csv_path = 'home1/thotappa/hw2-autocorrect/assignment_data/train_fold.csv'
    validation_csv_path = 'home1/thotappa/hw2-autocorrect/assignment_data/val_fold.csv'
